...
//   ProfileUserData({this.updatedProfileData});

//   ProfileUserData.fromJson(Map<String, dynamic> json) {
//     updatedProfileData = json['updatedProfileData'] != null
//         ? new UpdatedProfileData.fromJson(json['updatedProfileData'])
//         : null;
//   }
...
//       data['updatedProfileData'] = this.updatedProfileData!.toJson();
//     }
//     return data;
//   }
// }
...
//   UpdatedProfileData.fromJson(Map<String, dynamic> json) {
//     userId = json['user_id'];
